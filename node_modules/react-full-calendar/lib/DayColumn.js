        ...
        _react2.default.createElement(
          'div',
          {
            style: _extends({}, xStyle, (_extends2 = {
              top: top + '%',
              height: height + '%'
            }, _extends2[isRtl ? 'right' : 'left'] = Math.max(0, xOffset) + '%', _extends2.width = width + '%', _extends2.backgroundColor = [event.end < Date.now() ? '#808080' : '#3174AD'], _extends2.borderColor = [event.end < Date.now() ? '#808080' : '#3174AD'], _extends2)),
            title: label + ': ' + title,
